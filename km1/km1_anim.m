...
h.Visible = "on";
vid = VideoWriter("km1_anim_with_pauses.avi");
open(vid)
...
for a=1:total
    ...
    %Smoothing out the line of intersection
    ...
    %Graphing the line and the portion of the surface below the plane
    delete(ct)
